...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => 'user', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init(): void
    {
        ...
        $this->records = [
            [
                ...
                'password' => $hasher->hash('hunter12'),
                'first_name' => 'Bossy',
                'last_name' => 'Mc Boss Pants',
                'activation_date' => '2019-10-16 03:12:31',
                'active' => 1,
                'role' => 'admin',
                'created' => '2019-10-16 03:12:31',
                'modified' => '2019-10-16 03:12:31',
            ],
        ];
        parent::init();
    }
